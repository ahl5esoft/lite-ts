export abstract class RedisBase {
    ...
    public abstract publish(channel: string, message: any): Promise<number>;
    ...
    public abstract subscribe(channels: string[], callback: (message: string) => void): Promise<number>;
