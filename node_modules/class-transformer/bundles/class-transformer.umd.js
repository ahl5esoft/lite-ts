(function (global, factory) {
    ...
    var ClassTransformer = /** @class */ (function () {
        ...
        ClassTransformer.prototype.classToPlain = function (object, options) {
            var executor = new TransformOperationExecutor(exports.TransformationType.CLASS_TO_PLAIN, options || {});
        ...
        ClassTransformer.prototype.plainToClass = function (cls, plain, options) {
            var executor = new TransformOperationExecutor(exports.TransformationType.PLAIN_TO_CLASS, options || {});
        ...
        ClassTransformer.prototype.classToClass = function (object, options) {
            var executor = new TransformOperationExecutor(exports.TransformationType.CLASS_TO_CLASS, options || {});
            return executor.transform(undefined, object, undefined, undefined, undefined, undefined);
        };
